                        ...
                        <div class="freelancers-container freelancers-list-layout compact-list margin-top-35">
                            ...
                            <div class="freelancer">
                                ...
                                <div class="freelancer-details">
                                    ...
                                    <a href="freelancer_profile.php" class="button button-sliding-icon ripple-effect">View Profile <i class="icon-material-outline-arrow-right-alt"></i></a>
                                </div>
                            </div>
                            <!-- Freelancer / End -->
                            <!--Freelancer -->
                            ...
                            <div class="freelancer">
                                ...
                                <div class="freelancer-overview">
                                    <div class="freelancer-overview-inner">
                                        ...
                                        <div class="freelancer-avatar">
                                            <div class="verified-badge"></div>
                                            <a href="freelancer_profile.php"><img src="images/user-avatar-big-03.jpg" alt=""></a>
                                        </div>
                                        <!-- Name -->
                                        <div class="freelancer-name">
