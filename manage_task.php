                                ...
                                <ul class="dashboard-box-list">
                                    <li>
                                        ...
                                        <div class="buttons-to-right always-visible">
                                            <a href="manage_bidders.php" class="button ripple-effect"><i class="icon-material-outline-supervisor-account"></i> Manage Bidders <span class="button-info">3</span></a>
