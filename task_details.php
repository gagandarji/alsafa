                        ...
                        <ul class="boxed-list-ul">
                                ...
                                <div class="bid">
                                    ...
                                    <div class="bids-avatar">
                                        <div class="freelancer-avatar">
                                            ...
                                            <a href="freelancer_profile.php"><img src="images/user-avatar-big-01.jpg" alt=""></a>
                                        </div>
                                    </div>
                                    <!-- Content -->
                                    <div class="bids-content">
                                        ...
                                        <div class="freelancer-name">
                                            <h4><a href="freelancer_profile.php">Tom Smith <img class="flag" src="images/flags/gb.svg" alt="" title="United Kingdom" data-tippy-placement="top"></a></h4>
                            ...
                            <li>
                                <div class="bid">
                                    ...
                                    <div class="bids-avatar">
                                        <div class="freelancer-avatar">
                                            <div class="verified-badge"></div>
                                            <a href="freelancer_profile.php"><img src="images/user-avatar-big-02.jpg" alt=""></a>
                                        </div>
                                    </div>
                                    <!-- Content -->
                                    <div class="bids-content">
                                        <!-- Name -->
                                        <div class="freelancer-name">
                                            <h4><a href="freelancer_profile.php">David Peterson <img class="flag" src="images/flags/de.svg" alt="" title="Germany" data-tippy-placement="top"></a></h4>
                            ...
                            <li>
                                <div class="bid">
                                    ...
                                    <div class="bids-avatar">
                                        <div class="freelancer-avatar">
                                            <a href="freelancer_profile.php"><img src="images/user-avatar-placeholder.png" alt=""></a>
                                        </div>
                                    </div>
                                    <!-- Content -->
                                    <div class="bids-content">
                                        <!-- Name -->
                                        <div class="freelancer-name">
                                            <h4><a href="freelancer_profile.php">Marcin Kowalski <img class="flag" src="images/flags/pl.svg" alt="" title="Poland" data-tippy-placement="top"></a></h4>
                            ...
                            <li>
                                <div class="bid">
                                    ...
                                    <div class="bids-content">
                                        <!-- Name -->
                                        <div class="freelancer-name">
                                            <h4><a href="freelancer_profile.php">Sebastiano Piccio <img class="flag" src="images/flags/it.svg" alt="" title="Italy" data-tippy-placement="top"></a></h4>
