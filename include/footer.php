...
<!-- <div id="footer">  
    <div class="footer-bottom-section">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    © 2021 <strong>AlSafa</strong>. All Rights Reserved.
                </div>
            </div>
        </div>
    </div> 
...
<div class="foot-mobile">
    <ul class="list-inlien">
        <li class="list-inline-item">
            <a href="#"> <i class="icon-feather-log-in"></i> <br> Home</a>
        </li>
       
        <li class="list-inline-item">
            <a href="#"> <i class="icon-feather-log-in"></i> <br> Rates</a>
        </li>
        <li class="list-inline-item">
            <a href="#"> <i class="icon-feather-log-in"></i> <br> Transfer</a>
        </li>
        <li class="list-inline-item">
            <a href="#"> <i class="icon-feather-log-in"></i> <br> Location</a>
        </li>
        <li class="list-inline-item">
            <a href="#"> <i class="icon-feather-log-in"></i> <br> Chat</a>
        </li>
    </ul>
</div>
</div>
